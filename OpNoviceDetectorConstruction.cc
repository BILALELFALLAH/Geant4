...
{
       	world_hx = world_hy = world_hz =  3.0*m; // cube 3*3*3 m
}
...
// generate and add Materail properties table----------------
...
//_Volumeeee_______________________________________________________-
//

  G4Box * worldBox 
	 =  new G4Box("world",world_hx ,world_hy, world_hz);
//
// THe water world_______________________________________________________-
//
 G4LogicalVolume* world_log
                 = new G4LogicalVolume(worldBox,water,"world",0,0,0);
